...
function makeAjaxToFillCombos() {
    $.ajax({
        url: "/Student/FindSubjects",
        type: "GET",
        dataType: "json",
        success: function (data) {            
            var $select = $('#subSearch');            
            $.each(data._subList, function () {                
...
function fetchMentors() {
    $.ajax({
        url: "/Student/FindMentors",
        type: "GET",
        data: { subject: $('#subSearch').val() },
        dataType: "html",
        success: function (data) {
            $("#mentorList").html(data);
        }
    });
}
